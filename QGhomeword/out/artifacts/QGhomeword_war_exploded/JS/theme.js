    ...
    $ajax({
        ...
        success: function (result) {
            ...
            if (obj.flag === true) {
                ...
                /* 若用户有设置头像 */
                if(obj.data.head) {
                    document.querySelector(".header-main").getElementsByTagName("img")[0].setAttribute("src", obj.data.head);
                    if(document.getElementById("setHead")) {
                        /* 将路径写入头像框 */
                        document.querySelector(".setting-photo").getElementsByTagName("img")[0].setAttribute("src", obj.data.head);
                    }
                }
